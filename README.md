...
# Character width
print(unicode_segmentation_rs.text_width('A'))    # Some(1)
print(unicode_segmentation_rs.text_width('世'))   # Some(2)
print(unicode_segmentation_rs.text_width('\t'))   # None (control character)
```
